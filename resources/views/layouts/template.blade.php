...
<body id="page-top">
     ...
     <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-light sidebar sidebar-light accordion toggled" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAccesos"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>{{Auth::User()->name}}</span>
                </a>
                <div id="collapseAccesos" class="collapse" aria-labelledby="headingUtilities"
            ...
            <li class="nav-item">
                ...
                <div id="collapseSoporte" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a href="{{route('loginGoogle')}}" class="btn btn-user nav-link btn-block">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{route('loginGoogle')}}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Iniciar Sesión
                                </a>
